...
if(isset($_POST['simpan'])){
    ...
    if(empty($error)){
        ...
        if($id != ""){
            $sql1   = "update bestseller set nama = '$nama', picture='$picture_name', content='$content', date=now() where id='$id'";
        }else{
            $sql1   = "insert into bestseller (nama,picture,content) values ('$nama','$picture_name','$content')";
        }
        $q1     = mysqli_query($mysqli,$sql1);
        if($q1){
...
?>
    ...
    <h1>Input Data Best Seller Products</h1>
    <div class="mb-3 row">
        <a href="bestseller.php">Back to Best Seller Page</a>
    </div>
